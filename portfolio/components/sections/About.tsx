    ...
    <section id="about" className="px-6 sm:px-12 lg:px-24 py-24">
      <div data-aos="fade-up">
        <div className="inline-flex items-center gap-3 px-6 py-2 rounded-full bg-[#1a1a1a] border border-white/5 mb-10">
          <span className="text-xs font-bold text-white/50 uppercase tracking-[0.2em] pt-0.5">About</span>
        </div>
      </div>
        ...
        <div data-aos="fade-up" data-aos-delay="400" className="lg:col-span-2">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="glass-panel rounded-3xl p-8 text-center bg-[#0a0a0a]/50 hover:border-[#D946EF]/30 transition-all duration-500">
                <span className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#D946EF] to-[#A855F7] block mb-2">
                  {stat.value}
                </span>
                <span className="text-white/50 text-xs font-bold uppercase tracking-wider">{stat.label}</span>
              </div>
            ))}
          </div>
        </div>
